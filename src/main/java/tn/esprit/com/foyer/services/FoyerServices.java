...
public class FoyerServices implements IFoyerService{
    ...
    public Foyer retrieveFoyer(long idFoyer) {
        return foyerRepository.findById(String.valueOf(idFoyer)).get();
    }

    @Override
    public void archiverFoyer(long idFoyer) {
        Foyer f = foyerRepository.findById(String.valueOf(idFoyer)).get();
        f.setArchived(true);
    ...
    public void deleteFoyer(long idFoyer) {
        foyerRepository.deleteById(String.valueOf(idFoyer));
    }
}
